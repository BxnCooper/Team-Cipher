...
export default function ProfilePage() {
  ...
  useEffect(() => {
    // VULNERABILITY: IDOR - any user can view any profile by changing the ID in the URL
    // No authorization check, sequential IDs make it easy to enumerate
    fetch(`${API}/api/profile/${id}`)
      .then(res => res.json())
      .then(data => {
        // VULNERABILITY: Information Disclosure - API returns sensitive fields
        // (email, password hash, etc.) and frontend displays them
